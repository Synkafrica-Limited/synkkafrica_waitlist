  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-8">
      <div className="max-w-4xl w-full bg-white dark:bg-zinc-900 rounded-2xl shadow-md p-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-6">Thanks for your interest in joining Synkkafrica as a vendor. We'll guide you through verification, pricing, and how to manage bookings and payouts.</p>
